...
* Concrete monosaccharides now support explicit unusual absolute configurations using a leading `D` or `L`, such as `DFuc`, `LGul`, and `DFucf`; unprefixed names retain their natural configurations.
