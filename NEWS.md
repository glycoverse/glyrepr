...
* `as_glycan_structure()` gains `on_failure = "na"` to preserve valid elements while replacing element-local parsing or validation failures with `NA` and reporting one aggregated warning. (#72)
