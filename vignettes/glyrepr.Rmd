...
`glyrepr` supports both types of names, and you can mix them in the same vector or even in the same glycan.
...
They contain complete linkage information.
...
To accommodate these scenarios, `glyrepr` defines three levels of glycan structures.
These levels depend only on linkage and anomer information:

- **Intact**: all linkage and anomer information is complete and unambiguous.
- **Partial**: some linkage or anomer information is present, but it is not complete.
- **Topological**: all linkage and anomer information is missing.

Floating parts do not change these definitions. Their attachment linkage is
assessed like any other linkage, while uncertainty about the candidate parent
is independent of the structure level.

Structure levels are defined per glycan and do not depend on whether residues
are generic, concrete, or mixed.
...
Generic structures use the same linkage-based levels. For example, these are
topological structures:
...
They also have structure-specific helpers for removing linkages and
substituents.
