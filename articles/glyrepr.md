...
toc()
#> Converting 5,000 structures: 0.022 sec elapsed
```
...
#> [1] dplyr_1.1.4        tibble_3.3.0       tictoc_1.2.1       glyrepr_0.8.0.9000
#> 
...
#> [29] magrittr_2.0.4    digest_0.6.37     lifecycle_1.0.4   vctrs_0.6.5      
