...
This outlines how to propose a change to glyrepr. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyrepr", fork = TRUE)`.
...
Please note that the glyrepr project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glyrepr/dev/CODE_OF_CONDUCT.md).
