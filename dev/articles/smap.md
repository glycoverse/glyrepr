...
toc()
#> smap_int (optimized): 0.018 sec elapsed
...
toc()
#> Naive approach (all graphs): 0.138 sec elapsed
...
#> [1] tictoc_1.2.1       lobstr_1.2.2       glyrepr_1.1.0.9000
#> 
...
#> [25] xfun_0.61         fs_2.1.0          sass_0.4.10       otel_0.2.0       
